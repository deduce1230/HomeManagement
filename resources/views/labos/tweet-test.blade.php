...
<div class="container">
    ...
    <form class="meal-input-form" method="post" action="/hm_twitter/tweet_rec" autocomplete="off" name="tweetform">
      @csrf
      <h6>日付</h6>
      <div class="item">

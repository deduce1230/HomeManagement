...
<div class="container">
    ...
    <form class="meal-input-form" method="post" action="/hm_twitter/tweet_update" autocomplete="off" name="tweetform" enctype="multipart/form-data">
      @csrf
          ...
          <tr>
             <td style="border:none;">
                  <input type="text"  id="hashtag"
                         ...
                         placeholder="追加は右のリストボタンから"
                         value='{{$tweet_data[0]->hashtag }}'>
      ...
      <div style="display: flex;">
          ...
          <label for="file_photo" class="btn-real btn-real3" style="margin-left:10px" id="file-input">
             ...
             -->
             <input type="file" id="file_photo" name="photo_original" style="display:none;">
          </label>
      ...
      <div style="display: flex;" class="hm-div">
         <label class="check_btn" style="margin-left:10px;">
          <input type="checkbox" name='originalsize' id='originalsize'>
              <i class="fa fa-square-o fa-2x"></i>
              <i class="fa fa-check-square-o fa-2x"></i>
              <span style="color: #333; font-size:14px;"> オリジナルサイズで送信 </span>
         </label>
      </div>
...
-->
      ...
      <canvas id="canvas_show" style="border:0px solid; display:none;"></canvas>
...
-->
          <a class="btn btn-secondary" href="{{ session()->get('checkPointURL') }}">
                戻る
          </a>
      ...
      <div class="py-3">
         <a class="btn btn-danger" onClick="return confirm('一言日記を削除します。よろしいですか？');" 
            href="/hm_twitter/tweet_delete/{{$tweet_data[0]->rec_id}}">
               削除
         </a>
      </div>
...
@if (file_exists(public_path('/photos/diary/diary'.$tweet_data[0]->rec_id.'.jpg')))
...
<!-- ハッシュタグボタンクリック時の処理 START -->
<!-- モーダルエリアここから -->
<section id="modalArea" class="modalArea">
  <div id="modalBg" class="modalBg"></div>
    <div class="modalWrapper">
      <span id="group_info"></span></p>
      <table id="tblHashtags" class="modalTable">
      </table>

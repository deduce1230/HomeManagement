...
<div class="container">
    ...
    <form class="meal-input-form" method="post" action="/hm_twitter/tweet_rec" autocomplete="off" name="tweetform" enctype="multipart/form-data">
      @csrf
      <h6>日付</h6>
      <div class="item">
        <input type="date" id="tweet_date" name="tweet_date" value='{{ $target_date->format('Y-m-d') }}'>
      </div>

...
@section('content')
<div class="container">
    <h5> <a href='/cooking/record/'>メニュー日付検索</a></h5>
...
<!--
      ...
      <div class="meal-select">
          <input id="select_area1" class="radio-inline__input" type="radio" name="search_type" 
                 value="1" checked>
          <label class="radio-inline__label" for="select_area1">材料名／メニュー名から検索</label>
...
// 選択した日付範囲でメニュー検索をかける
   ...
   window.location.href='/cooking/search_calendar/' + date_s.value + '/' + date_e.value; 
}
function set_days(){
   var date_s = document.getElementById("meal_date_s");
   var date_e = document.getElementById("meal_date_e");

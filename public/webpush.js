...
self.addEventListener('load', async () => {
    if ('serviceWorker' in navigator) {
        window.sw = await navigator.serviceWorker.register('/sw_push.js', {scope: '/'});
    }
});
...
async function allowWebPush() {
    ...
    // 取得したPublicKey
    const appServerKey = 'BIO6BC_OWKp_bqRRZZefiwigzGGnInhAaWwu-qcyDSyDp_UCCAcKrnA7-tsQEc_BvbBGAJPK4VYTr_2o4XLpF58';
    ...
    console.log(request);
// --- 2022.10.19 Add Start ---
    const rtn=[subscription.endpoint,
